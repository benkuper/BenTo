...
#define ApplicationName 'BenTo'
#define ApplicationVersion GetStringFileInfo('Binaries/CI/App/BenTo.exe',"ProductVersion")
...
AppPublisherURL=http://github.com/benkuper/BenTo
...
[Files]
Source: "Binaries/CI/App/*.exe"; DestDir: "{app}" ; Flags: ignoreversion
; Source: "Binaries/CI/App/*.bin"; DestDir: "{app}" ; Flags: ignoreversion
