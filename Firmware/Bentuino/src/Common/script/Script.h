...
#define SCRIPT_WASM_STACK_SLOTS 2000
#define SCRIPT_NATIVE_STACK_SIZE (32 * 1024)
#define SCRIPT_WASM_MEMORY_LIMIT 4096
#define SCRIPT_WASM_ASYNC 0
...
public:
    ...
    // const uint8_t scriptData[197] = { 0x00, 0x61, 0x73, 0x6d, 0x01, 0x00, 0x00, 0x00, 0x01, 0x11, 0x04, 0x60,
