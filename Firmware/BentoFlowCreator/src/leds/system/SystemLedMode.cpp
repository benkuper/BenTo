...
void SystemLedMode::update()
{
   ...
   if (connectionState == Off || connectionState != Connecting && relT > animTime) return;
   ...
   if (connectionState != Connecting)
   {
      ...
      {
      case Connected:
         targetColor = CRGB::Green; break;
      case ConnectionError:
         targetColor = CRGB::Red; break;
      case Disabled:
         targetColor = CRGB::Purple; break;
      case Hotspot:
         targetColor = CRGB::Yellow; break;
      }
